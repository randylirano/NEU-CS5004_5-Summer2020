...
/**
 * CS5004 Assignment 5: Problem 2 - Rational Class.
...
public class RationalTest {
    ...
    public static void main(String[] args) {
        ...
        // Rational number3 = new Rational(0, 60);
        ...
        Rational number4 = new Rational();
        System.out.println(number4);
        System.out.println("Numerator: " + number4.getNumerator());
        System.out.println("Denominator: " + number4.getDenominator());
        Rational number5 = new Rational(0, 60);
        System.out.println(number5);
        System.out.println("Numerator: " + number5.getNumerator());
        System.out.println("Denominator: " + number5.getDenominator());
